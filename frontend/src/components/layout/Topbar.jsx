...
export default function Topbar({ systemState }) {
  ...
  return (
    <header className="h-16 border-b border-halcyon-border/50 bg-halcyon-surface/80 backdrop-blur-md flex items-center justify-between px-8 sticky top-0 z-10 shadow-sm transition-colors duration-500">
      <div className="flex items-center gap-4">
        <div className={`text-xs font-mono uppercase tracking-wider font-bold px-3 py-1 rounded-full border transition-colors duration-500 ${
          isChaotic 
